...
export interface EtatSurface {
  [key: string]: string | Photo[]; trous: string;
  reg1: string; reg1Photos: Photo[]; reg1Comment: string;
  prop1: string; prop1Photos: Photo[]; prop1Comment: string;
  troudebranche: string; troudebranchePhotos: Photo[]; troudebrancheComment: string;
...
export interface Releves {
  [key: string]: string;
  entraxe_vertical: string;
  entraxe_horizontal: string;
  nu_facade: string;
  traitement: string;
  aplomb: string;
}
