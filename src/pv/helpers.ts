...
export const createPdfDataFromPV = (pv: {
  ...
  etatSurface: pv.etatSurface || {trous: "SO", reg1: "SO", reg1Photos: [], reg1Comment: "", prop1: "SO", prop1Photos: [], prop1Comment: "", troudebranche: "SO", troudebranchePhotos: [], troudebrancheComment: "", prop2: "SO", prop2Photos: [], prop2Comment: "" },
  partieCourante: pv.partieCourante || { planeite: "SO",  tolerance: "SO", niveau: "SO", arase: "SO" },
  releves: pv.releves || { entraxe_vertical: "SO", entraxe_horizontal: "SO", nu_facade: "SO", traitement: "SO", aplomb: "SO" },
  points: pv.points || { reservations: "SO", joints: "SO", observations: "" },
...
export const createPdfDataFromVersion = (version: {
  ...
  etatSurface: version.etatSurface || {trous: "SO", reg1: "SO", reg1Photos: [], reg1Comment: "", prop1: "SO", prop1Photos: [], prop1Comment: "", troudebranche: "SO", troudebranchePhotos: [], troudebrancheComment: "", prop2: "SO", prop2Photos: [], prop2Comment: "" },
  partieCourante: version.partieCourante || { planeite: "SO",  tolerance: "SO", niveau: "SO", arase: "SO" },
  releves: version.releves || { entraxe_vertical: "SO", entraxe_horizontal: "SO", nu_facade: "SO", traitement: "SO", aplomb: "SO" },
  points: version.points || { reservations: "SO", joints: "SO", observations: "" },
